...
func _physics_process(delta: float) -> void:
	match current_state:
		...
		states.down:
			...
			velocity = Vector2.DOWN * eyeSpeed
...
func move():
	...
	#elif move_counter == 1 and num_of_moves == 2:
		#count_dir = "reverse"
	elif move_counter == 0:
		count_dir = "forward"
